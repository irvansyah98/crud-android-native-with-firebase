...
public class ReadActivity extends AppCompatActivity implements BarangAdapter.FirebaseDataListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        database.child("barang").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                 ...
                 */
                adapter = new BarangAdapter(daftarBarang, ReadActivity.this);
