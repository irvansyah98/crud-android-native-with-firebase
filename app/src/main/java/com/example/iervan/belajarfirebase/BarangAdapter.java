    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.tvTitle.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                context.startActivity(DetailActivity.getActIntent((Activity) context).putExtra("data", daftarBarang.get(position)));
            }
        });
            ...
            public boolean onLongClick(View view) {
                ...
                editButton.setOnClickListener(
                        new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                dialog.dismiss();
                                context.startActivity(CreateActivity.getActIntent((Activity) context).putExtra("data", daftarBarang.get(position)));
                            }
                        }
                );
